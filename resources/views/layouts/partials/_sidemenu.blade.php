<div class="col-md-3 float-left col-1 pl-0 pr-0 collapse width show" id="sidebar">
    <div class="list-group border-0 card text-center text-md-left">
        ...
        <a href="#menu1" class="list-group-item d-inline-block collapsed" data-toggle="collapse" aria-expanded="false"><i class="fa fa-dashboard"></i> <span class="d-none d-md-inline">Users</span> </a>
        <div class="collapse" id="menu1" data-parent="#sidebar">
            <a href=" {{ route('user.create') }}" class="list-group-item">Create User</a>
            <a href="#menu1sub1sub1" class="list-group-item" data-toggle="collapse" aria-expanded="false">All Users </a>
                <div class="collapse" id="menu1sub1sub1">
                    <a href=" {{ route('user.index') }}" class="list-group-item">Members</a>
                    <a href=" {{ route('user.unapproved') }}" class="list-group-item">Unapproved users</a>
                </div>
        </div>
        <a href="#menu2" class="list-group-item d-inline-block collapsed" data-toggle="collapse" aria-expanded="false"><i class="fa fa-dashboard"></i> <span class="d-none d-md-inline">Company</span> </a>
        ...
        <a href="#menu3" class="list-group-item d-inline-block collapsed" data-toggle="collapse" aria-expanded="false"><i class="fa fa-dashboard"></i> <span class="d-none d-md-inline">Contracts</span> </a>
